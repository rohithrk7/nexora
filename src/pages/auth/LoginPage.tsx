        ...
        <div className="flex flex-col items-center justify-center min-h-[80vh] px-4 py-12 bg-slate-50">
            <div className="w-full max-w-md bg-white border border-slate-200 rounded-3xl p-8 shadow-xl relative overflow-hidden">
                ...
                <div className="text-center mb-8 relative z-10">
                    ...
                    <p className="text-slate-500 mt-2">Log in to your NEXORA account</p>
                </div>
                ...
                <form className="space-y-6 relative z-10" onSubmit={(e) => e.preventDefault()}>
                    ...
                    <Button onClick={handleGoogleSignIn} variant="outline" type="button" className="w-full h-12 bg-white text-slate-700 font-semibold border-slate-200 hover:bg-slate-50 rounded-xl shadow-sm">
                ...
                <p className="text-center text-sm text-slate-500 mt-8 relative z-10">
                    Don't have an account? <Link to="/signup" className="font-bold text-orange-600 hover:text-orange-700 transition-colors">Sign up</Link>
                </p>
            </div>
        </div>
    );
